    ...
    <Fragment>
      {features.length > 0
        ? features?.map((el) => (
            <div
              key={el.id}
              className={`${styles.customCol} ${styles.cardContainer} shadow-2xl w-[250px] sm:w-[300px] md:w-[298px] transition-all duration-500 border-spacing-1 rounded-[60px] overflow-hidden lg:mx-10 mb-3 `}
